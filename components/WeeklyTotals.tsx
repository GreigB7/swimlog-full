  ...
  return (
    <div className="card">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="p-3 rounded-lg bg-slate-50 border"><div className="text-xs text-slate-500">Swim</div><div className="text-xl font-semibold">{swim} min</div></div>
        <div className="p-3 rounded-lg bg-slate-50 border"><div className="text-xs text-slate-500">Land</div><div className="text-xl font-semibold">{land} min</div></div>
        <div className="p-3 rounded-lg bg-slate-50 border"><div className="text-xs text-slate-500">Other</div><div className="text-xl font-semibold">{other} min</div></div>
        <div className="p-3 rounded-lg bg-slate-50 border"><div className="text-xs text-slate-500">Total</div><div className="text-xl font-semibold">{total} min</div></div>
      </div>
    </div>
  );
}
